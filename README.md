...
```sh
git clone git@github.com:luming-xyz/chisel-test-template.git
cd chisel-test-template
```
...
#### Commit your changes
```sh
git commit -m 'Starting chisel-test-template'
...
```sh
mill chisel-test-template.test
```
